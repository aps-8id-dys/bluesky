...
aps_8id_bs_instrument note:: The motor assignments are set in the IOC
...
aps_8id_bs_instrument warning: (!) Some motor assignments in the training IOC are misconfigured.

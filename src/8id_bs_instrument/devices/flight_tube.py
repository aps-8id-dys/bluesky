...
det = FlightTubeDetector("8idiFlight:", name="det") #TODO: "Ensure variable name is as desired"
bs = FlightTubeBeamStop("8idiFlight:", name="bs") #TODO: "Ensure variable name is as desired"

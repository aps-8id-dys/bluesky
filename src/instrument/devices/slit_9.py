...
class CustomOptics2Slit1D(Optics2Slit1D):
    ...
    center = cpt(PVPositionerSoftDone, "", setpoint_pv="center", readback_pv="center.RBV")
    sync = cpt(EpicsSignal, "doSync", put_complete=True, kind="omitted") #TODO: What is the pv value for sync

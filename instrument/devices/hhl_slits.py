...
wb_slit = HHLSlits(name="wb_slit", prefix="8idaSoft:CR8-A1:US", pitch_motor="m3", yaw_motor="m4", horizontal_motor="m1", diagonal_motor="m2")
mono_slit = HHLSlits(name="mono_slit", prefix="8idaSoft:CR8-A1:US", pitch_motor="m11", yaw_motor="m12", horizontal_motor="m9", diagonal_motor="m10")
